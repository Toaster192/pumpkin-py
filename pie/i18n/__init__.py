...
class TranslationContext:
    ...
    :class:`disnake.RawReactionActionEvent`. This may be used to get around.
...
class Translator:
    ...
    def translate(
        self,
        ctx: Union[disnake.ext.commands.Context, TranslationContext],
        string: str,
    ) -> str:
    ...
    def get_language_preference(
        self, ctx: Union[disnake.ext.commands.Context, TranslationContext]
    ) -> str:
        ...
        * Return the bot default.
        ...
        elif ctx.__class__ == disnake.ext.commands.Context and isinstance(
            ctx.channel, disnake.abc.PrivateChannel
        ):
            guild_id, user_id = None, ctx.author.id
        elif ctx.__class__ == disnake.ext.commands.Context and not isinstance(
            ctx.channel, disnake.abc.PrivateChannel
        ):
