...
class ACL(commands.Cog):
    ...
    async def acl_mapping_add(self, ctx, role: disnake.Role, level: str):
    ...
    async def acl_mapping_remove(self, ctx, role: disnake.Role):
    ...
    async def acl_overwrite_role_add(
        self, ctx, command: str, role: disnake.Role, allow: bool
    ):
    ...
    async def acl_overwrite_role_remove(self, ctx, command: str, role: disnake.Role):
    ...
    async def acl_overwrite_user_add(
        self, ctx, command: str, user: disnake.Member, allow: bool
    ):
    ...
    async def acl_overwrite_user_remove(self, ctx, command: str, user: disnake.Member):
    ...
    async def acl_overwrite_channel_add(
        self, ctx, command: str, channel: disnake.TextChannel, allow: bool
    ):
    ...
    async def acl_overwrite_channel_remove(
        self, ctx, command: str, channel: disnake.TextChannel
    ):
