...
class Errors(commands.Cog):
    ...
    async def handle_exceptions(ctx, error) -> Tuple[str, str, bool]:
        ...
        # Discord errors
        elif isinstance(error, disnake.DiscordException):
    ...
    async def handle_DiscordException(ctx, error) -> Tuple[str, str, bool]:
        ...
        if isinstance(error, disnake.ClientException):
            return await Errors.handle_ClientException(ctx, error)
        # Exception that is raised when an async iteration operation has no more items.
        elif isinstance(error, disnake.NoMoreItems):
        ...
        elif isinstance(error, disnake.GatewayNotFound):
            return (
                _(ctx, "Error"),
    ...
    async def handle_ClientException(ctx, error) -> Tuple[str, str, bool]:
        ...
        if isinstance(error, disnake.InvalidData):
            return (
                _(ctx, "Client error"),
                _(ctx, "Invalid data"),
                False,
        ...
        elif isinstance(error, disnake.InvalidArgument):
            return (
                _(ctx, "Client error"),
        ...
        elif isinstance(error, disnake.LoginFailure):
            return (
                _(ctx, "Client error"),
                _(ctx, "Login failure"),
                False,
        ...
        elif isinstance(error, disnake.ConnectionClosed):
            return (
                _(ctx, "Client error"),
        ...
        elif isinstance(error, disnake.PrivilegedIntentsRequired):
            return (
                _(ctx, "Client error"),
    ...
    async def handle_HTTPException(ctx, error) -> Tuple[str, str, bool]:
        ...
        elif isinstance(error, disnake.DiscordServerError):
            return (
                _(ctx, "HTTP Exception"),
